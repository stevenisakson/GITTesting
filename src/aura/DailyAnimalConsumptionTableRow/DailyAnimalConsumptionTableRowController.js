({
    ...
    percent_of_shareChanged:function(cmp,event,helper){
        ...
        if(cmp.get('v.row').product_function!='None' && cmp.get('v.row').pftype!='None'){
            ...
            if(row.percent_of_share!=null && row.total!=null){
